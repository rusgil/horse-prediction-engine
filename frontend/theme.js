...
(function () {
  ...
  var css = [
    ...
    '  font-family: \'Barlow Condensed\', system-ui, sans-serif; font-weight: 800; font-size: 0.8rem;',
    '  letter-spacing: 0.07em; text-transform: uppercase; padding: 8px 18px; border-radius: 999px;',
    '  color: #fff; background: linear-gradient(180deg, #2fd36a 0%, #17a34a 100%);',
    '  border: 1px solid rgba(0,0,0,0.10);',
    '  box-shadow: 0 2px 9px rgba(22,163,74,0.34), inset 0 1px 0 rgba(255,255,255,0.28);',
    '  transition: transform 0.12s ease, box-shadow 0.16s ease, filter 0.16s ease; }',
    '.fiq-login.on { display: inline-flex; align-items: center; gap: 6px; }',
    '.fiq-login:hover { transform: translateY(-1px); filter: saturate(1.05);',
    '  box-shadow: 0 5px 16px rgba(22,163,74,0.46), inset 0 1px 0 rgba(255,255,255,0.34); }',
    '.fiq-login:active { transform: translateY(0); box-shadow: 0 2px 7px rgba(22,163,74,0.36), inset 0 1px 0 rgba(255,255,255,0.22); }',
